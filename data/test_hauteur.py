...
def plot_courbes_moyennes(csv_path):
    ...
    plt.xlabel("Taille (n)")
    plt.ylabel("Hauteur moyenne (en nombre de nœuds)")
    plt.title("Hauteur moyenne en fonction de la taille")
    plt.legend()
    plt.grid(True)

    plt.savefig("hauteur_moyenne_vs_taille.png", dpi=300, bbox_inches="tight")
    plt.close()
